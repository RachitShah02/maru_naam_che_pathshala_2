...
class EndPoints {
  ...
  static String attendenceCalander = 'attendence-calander';
  static String attendenceList = 'attendence-list';
  static String sutraList = 'sutra-list';
  static String pointsList = 'points-list';
  static String pointsCard = 'points-card';
